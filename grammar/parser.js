...
switch( state )
{
    case 0:
        ...
        else if( info.src.charCodeAt( pos ) == 9 ) state = 27;
        else if( info.src.charCodeAt( pos ) == 60 ) state = 29;
        else state = -1;
        break;
    ...
    case 27:
        if( info.src.charCodeAt( pos ) == 10 ) state = 28;
        else state = -1;
        break;
    ...
    case 29:
        ...
        else if( info.src.charCodeAt( pos ) == 65 ) state = 31;
        else if( info.src.charCodeAt( pos ) == 69 ) state = 32;
        else if( info.src.charCodeAt( pos ) == 83 ) state = 33;
        else if( info.src.charCodeAt( pos ) == 84 ) state = 34;
        else if( info.src.charCodeAt( pos ) == 66 ) state = 81;
        else if( info.src.charCodeAt( pos ) == 73 ) state = 82;
        else state = -1;
        break;

    case 30:
        if( info.src.charCodeAt( pos ) == 84 ) state = 83;
        else if( info.src.charCodeAt( pos ) == 69 ) state = 121;
        else if( info.src.charCodeAt( pos ) == 66 ) state = 127;
        else if( info.src.charCodeAt( pos ) == 73 ) state = 128;
        else if( info.src.charCodeAt( pos ) == 83 ) state = 130;
        else if( info.src.charCodeAt( pos ) == 65 ) state = 134;
        else state = -1;
        break;
    ...
    case 33:
        if( info.src.charCodeAt( pos ) == 84 ) state = 84;
        else state = -1;
        break;

    case 34:
        if( info.src.charCodeAt( pos ) == 77 ) state = 39;
        else if( info.src.charCodeAt( pos ) == 82 ) state = 107;
        else state = -1;
        break;

    case 35:
        if( info.src.charCodeAt( pos ) == 80 ) state = 41;
        else state = -1;
        break;

    case 36:
        if( info.src.charCodeAt( pos ) == 65 ) state = 42;
        else state = -1;
        break;

    case 37:
        if( info.src.charCodeAt( pos ) == 68 ) state = 43;
        else state = -1;
        break;

    case 38:
        if( info.src.charCodeAt( pos ) == 73 ) state = 44;
    ...
    case 41:
        if( info.src.charCodeAt( pos ) == 72 ) state = 46;
        else state = -1;
        break;

    case 42:
        if( info.src.charCodeAt( pos ) == 78 ) state = 47;
        else state = -1;
        break;

    case 43:
        if( info.src.charCodeAt( pos ) == 83 ) state = 98;
        else state = -1;
        break;

    case 44:
        if( info.src.charCodeAt( pos ) == 84 ) state = 48;
        else state = -1;
        break;

    case 45:
        if( info.src.charCodeAt( pos ) == 85 ) state = 49;
        else state = -1;
        break;

    case 46:
        if( info.src.charCodeAt( pos ) == 65 ) state = 51;
        else state = -1;
        break;

    case 47:
        if( info.src.charCodeAt( pos ) == 75 ) state = 52;
        else state = -1;
        break;

    case 48:
        if( info.src.charCodeAt( pos ) == 83 ) state = 104;
        else state = -1;
        break;

    case 49:
        if( info.src.charCodeAt( pos ) == 84 ) state = 54;
        else state = -1;
        break;

    case 50:
        if( info.src.charCodeAt( pos ) == 69 ) state = 55;
        else state = -1;
        break;

    case 51:
        if( info.src.charCodeAt( pos ) == 66 ) state = 60;
        else state = -1;
        break;
    ...
    case 53:
        if( info.src.charCodeAt( pos ) == 65 ) state = 93;
        else state = -1;
        break;
    ...
    case 56:
        if( info.src.charCodeAt( pos ) == 73 ) state = 101;
        else state = -1;
        break;
    ...
    case 61:
        if( info.src.charCodeAt( pos ) == 65 ) state = 102;
        else state = -1;
        break;
    ...
    case 64:
        if( info.src.charCodeAt( pos ) == 84 ) state = 126;
        else state = -1;
        break;

    case 65:
        if( info.src.charCodeAt( pos ) == 69 ) state = 68;
        else state = -1;
        break;

    case 66:
        if( info.src.charCodeAt( pos ) == 73 ) state = 70;
        else state = -1;
        break;
    ...
    case 68:
        if( info.src.charCodeAt( pos ) == 83 ) state = 72;
        else state = -1;
        break;

    case 69:
        if( info.src.charCodeAt( pos ) == 69 ) state = 73;
        else state = -1;
        break;

    case 70:
        if( info.src.charCodeAt( pos ) == 79 ) state = 74;
        else state = -1;
        break;
    ...
    case 78:
        ...
        else if( info.src.charCodeAt( pos ) == 83 ) state = 80;
        else state = -1;
        break;
    ...
    case 81:
        if( info.src.charCodeAt( pos ) == 76 ) state = 36;
        else state = -1;
        break;

    case 82:
        if( info.src.charCodeAt( pos ) == 78 ) state = 38;
        else state = -1;
        break;

    case 83:
        if( info.src.charCodeAt( pos ) == 77 ) state = 40;
        else if( info.src.charCodeAt( pos ) == 82 ) state = 120;
        else state = -1;
        break;

    case 84:
        if( info.src.charCodeAt( pos ) == 65 ) state = 87;
        else state = -1;
        break;

    case 85:
        if( info.src.charCodeAt( pos ) == 78 ) state = 89;
        else state = -1;
        break;

    case 86:
        if( info.src.charCodeAt( pos ) == 83 ) state = 90;
        else state = -1;
        break;

    case 87:
        if( info.src.charCodeAt( pos ) == 84 ) state = 50;
        else state = -1;
        break;

    case 88:
        if( info.src.charCodeAt( pos ) == 75 ) state = 57;
        else state = -1;
        break;

    case 89:
        if( info.src.charCodeAt( pos ) == 83 ) state = 56;
        else state = -1;
        break;
    ...
    case 91:
        if( info.src.charCodeAt( pos ) == 83 ) state = 63;
        else state = -1;
        break;

    case 92:
        if( info.src.charCodeAt( pos ) == 73 ) state = 64;
        else state = -1;
        break;
    ...
    case 94:
        if( info.src.charCodeAt( pos ) == 84 ) state = 67;
        else state = -1;
        break;

    case 95:
        if( info.src.charCodeAt( pos ) == 83 ) state = 75;
        else state = -1;
        break;
    ...
    case 97:
        if( info.src.charCodeAt( pos ) == 78 ) state = 78;
        else state = -1;
        break;
    ...
    case 99:
        if( info.src.charCodeAt( pos ) == 83 ) state = 58;
        else state = -1;
        break;

    case 100:
        if( info.src.charCodeAt( pos ) == 84 ) state = 59;
        else state = -1;
        break;
    ...
    case 102:
        if( info.src.charCodeAt( pos ) == 84 ) state = 69;
        else state = -1;
        break;

    case 103:
        if( info.src.charCodeAt( pos ) == 83 ) state = 92;
        else state = -1;
        break;
    ...
    case 105:
        if( info.src.charCodeAt( pos ) == 84 ) state = 71;
        else state = -1;
        break;

    case 106:
        if( info.src.charCodeAt( pos ) == 84 ) state = 96;
        else state = -1;
        break;

    case 107:
        if( info.src.charCodeAt( pos ) == 65 ) state = 85;
        else state = -1;
        break;

    case 108:
        if( info.src.charCodeAt( pos ) == 68 ) state = 86;
        else state = -1;
        break;
    ...
    case 110:
        if( info.src.charCodeAt( pos ) == 84 ) state = 99;
        else state = -1;
        break;

    case 111:
        if( info.src.charCodeAt( pos ) == 85 ) state = 100;
        else state = -1;
        break;

    case 112:
        if( info.src.charCodeAt( pos ) == 69 ) state = 91;
        else state = -1;
        break;

    case 113:
        if( info.src.charCodeAt( pos ) == 69 ) state = 105;
        else state = -1;
        break;

    case 114:
        if( info.src.charCodeAt( pos ) == 65 ) state = 106;
        else state = -1;
        break;

    case 115:
        if( info.src.charCodeAt( pos ) == 69 ) state = 95;
        else state = -1;
        break;

    case 116:
        if( info.src.charCodeAt( pos ) == 79 ) state = 97;
        else state = -1;
        break;

    case 117:
        if( info.src.charCodeAt( pos ) == 78 ) state = 103;
        else state = -1;
        break;

    case 118:
        if( info.src.charCodeAt( pos ) == 84 ) state = 112;
        else state = -1;
        break;

    case 119:
        if( info.src.charCodeAt( pos ) == 84 ) state = 115;
        else state = -1;
        break;
    ...
    case 121:
        if( info.src.charCodeAt( pos ) == 78 ) state = 108;
        else state = -1;
        break;

    case 122:
        if( info.src.charCodeAt( pos ) == 65 ) state = 109;
        else state = -1;
        break;

    case 123:
        if( info.src.charCodeAt( pos ) == 73 ) state = 110;
        else if( info.src.charCodeAt( pos ) == 80 ) state = 111;
        else state = -1;
        break;

    case 124:
        if( info.src.charCodeAt( pos ) == 66 ) state = 113;
        else state = -1;
        break;

    case 125:
        if( info.src.charCodeAt( pos ) == 65 ) state = 119;
        else state = -1;
        break;

    case 126:
        if( info.src.charCodeAt( pos ) == 73 ) state = 116;
        else state = -1;
        break;

    case 127:
        if( info.src.charCodeAt( pos ) == 76 ) state = 122;
        else state = -1;
        break;

    case 128:
        if( info.src.charCodeAt( pos ) == 78 ) state = 123;
        else state = -1;
        break;
    ...
    case 130:
        if( info.src.charCodeAt( pos ) == 84 ) state = 129;
        else state = -1;
        break;

    case 131:
        if( info.src.charCodeAt( pos ) == 65 ) state = 124;
        else state = -1;
        break;

    case 132:
        if( info.src.charCodeAt( pos ) == 72 ) state = 131;
        else state = -1;
        break;

    case 133:
        if( info.src.charCodeAt( pos ) == 80 ) state = 132;
        else state = -1;
        break;

    case 134:
        if( info.src.charCodeAt( pos ) == 76 ) state = 133;
        else state = -1;
        break;
...
var act_tab = new Array(
    ...
    /* State 31 */ new Array( 19/* "TRANSITIONSTART" */,40 ),
    ...
    /* State 60 */ new Array( 19/* "TRANSITIONSTART" */,40 , 18/* "TRANSITIONSEND" */,-15 ),
    /* State 61 */ new Array( 18/* "TRANSITIONSEND" */,-16 )
);
